/*******************************************************************************************************************************
 * AK.Aspects.Tests.Infrastructure.CreationPolicySharedTestImplementation
...
{
    /// <summary>
    /// Implementation class for the shared creation policy test.
    /// </summary>
    /// <author>Aashish Koirala</author>
    [Export(typeof (ICreationPolicySharedTestContract)),
     PartCreationPolicy(CreationPolicy.Shared),
     TestEntry,
     TestExit,
     TestError]
    public class CreationPolicySharedTestImplementation : ICreationPolicySharedTestContract
    {
